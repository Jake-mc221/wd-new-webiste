...
export const services: Service[] = [
  ...
  },
  {
    ...
    overview: [
      "Trade marks can be words, letters, numerals, logos, sounds, colours, shapes and even scents. The most powerful brands in the world — from McDonald's golden arches to Tiffany blue — are built on registered trade mark protection.",
      "Jennifer Song leads our trade mark practice with a specialist focus on helping clients build, protect and enforce brands across Australia and international markets. We advise businesses at every stage — from initial clearance before launch, through registration and maintenance, to enforcement and licensing.",
    ...
    offerings: [
      "Registrability assessments and clearance searches",
